...
def process_data(data):
  ...
  and a list of the total sales of each car made.
  """
...
def main(argv):
  ...
  summary, car_make_data = process_data(data)
  #print(summary)
  ...
  #Build the PDF
  report.build([report_title, report_summary, report_table, report_chart])
